...
$insert = "INSERT INTO usuarios (name_user, password_user, email_user, lenguage_user) 
           VALUES (:nombre, :pass, :email, :idioma);";
// 2. Preparación
...
session_start();
$_SESSION['usuario'] = $array_filas['nombre_usuario'];
