...
const palabraMays = console.log(palabra.toLocaleUpperCase()); // ABRACADABRA ==> pasar a mayúsculas guardando en una variable
...
const frase = 'Como no estudies javascript vas a suspender';
...
const lista = []; // array vacío para guardar las palabras de la frase
