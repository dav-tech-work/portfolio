...
const arraySize = frutas.length; // es el tamaño
...
console.log(frutas);
const arrayInvertido = frutas.toReversed(); // modifica el array original pero lo guarda en otra variable
console.log(frutas);
console.log(arrayInvertido);

// Cortar el Array: slice(posicionInicial, posicionFinal) sirver para obtener datos de un array
const frutasCortadas = frutas.slice(1, 3); // Devuelve un nuevo array con los elementos entre las posiciones 1 y 3
...
console.log(frutas);
const frutasOrdenadas = frutas.toSorted(); // Guarda en un array nuevo
